...
| 6 | Encoded PowerShell Execution | Base64-encoded PowerShell command execution | Sysmon Event ID `1` - Process Create | Wazuh | Rule `92057` | Level 12 | `T1059.001` — PowerShell |
